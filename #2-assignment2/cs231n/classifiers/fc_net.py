...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    results = {}
    results['layer1'] = affine_relu_forward(X, self.params['W1'], self.params['b1'])
    
    for i in range(2, self.num_layers):
        results['layer' + str(i)] = affine_relu_forward(
            results['layer' + str(i-1)][0],
            self.params['W'+ str(i)],
            self.params['b' + str(i)]
        )
    results['layer' + str(self.num_layers)] = affine_forward(
        results['layer' + str(self.num_layers-1)][0],
        self.params['W'+str(self.num_layers)],
        self.params['b'+str(self.num_layers)]
    )
    scores = results['layer' + str(self.num_layers)][0]
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    backprob['back' + str(self.num_layers)] = affine_backward(dout, results['layer' + str(self.num_layers)][1])
    
    dx, dw, db = backprob['back' + str(self.num_layers)]
    ...
    for i in reversed(range(1, self.num_layers)):
        backprob['back' + str(i)] = affine_relu_backward(dx, results['layer' + str(i)][1])
        dx, dw, db = backprob['back' + str(i)]
